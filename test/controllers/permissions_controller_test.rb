...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { description: @permission.description, document_id: @permission.document_id, name: @permission.name, role_id: @permission.role_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { description: @permission.description, document_id: @permission.document_id, name: @permission.name, role_id: @permission.role_id } }
