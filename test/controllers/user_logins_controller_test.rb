...
class UserLoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_login" do
    assert_difference('UserLogin.count') do
      post user_logins_url, params: { user_login: { timestamp: @user_login.timestamp, user_id: @user_login.user_id } }
    end
  ...
  test "should update user_login" do
    patch user_login_url(@user_login), params: { user_login: { timestamp: @user_login.timestamp, user_id: @user_login.user_id } }
